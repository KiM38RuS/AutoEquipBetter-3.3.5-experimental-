...
На данный момент реализован интерфейс замены старой экипировки на новую, а также индикация предмета, превосходящего надетый, в интерфейсе торговца и профессии, однако сам механизм анализа и сравнения экипировки требует доработки.
